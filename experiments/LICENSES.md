...
| `experiments/results/contrast.md`, `experiments/results/word_scatter.README.md` | Method notes for the two page-driven measurements (WCAG contrast; per-word injection scatter), each with the script that reproduces it | MIT, `../LICENSE` |
