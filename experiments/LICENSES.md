...
| `experiments/results/contrast.md`, `experiments/results/latency.md`, `experiments/results/word_scatter.README.md`, `experiments/results/pool_ladder.README.md`, `experiments/results/transformer_control.README.md`, `experiments/results/one_period_vs_two.md`, `experiments/results/onepager_test.md`, `experiments/results/full_schedule.README.md` | Method notes for the three page-driven measurements (WCAG contrast; interaction latency; per-word injection scatter), each with the script that reproduces it | MIT, `../LICENSE` |
